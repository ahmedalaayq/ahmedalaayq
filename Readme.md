...
**Responsibilities:**  
- Leading the Flutter team & mentoring student developers  
- Designing & delivering sessions on Flutter fundamentals, UI/UX, and state management  
...
- Guided students to build real-world applications & mini projects  
- Taught core concepts: UI building, state management, navigation, clean architecture  
- Provided code reviews & constructive feedback  
...
- Developed cross-platform mobile apps for startups & small businesses  
